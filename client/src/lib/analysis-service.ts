...
export class AnalysisService {
    ...
    ): Promise<ImageAnalysisEnsembleResponse> {
        try {
            const response = await api.post<ImageAnalysisEnsembleResponse>(
                "/analysis/analyze",
                request,
            );
            return response.data;
    ...
    static async analyzeSymptoms(
        ...
        try {
            const response = await api.post<SymptomsAnalysisResponse>(
                "/analysis/symptoms",
                request,
            );
            return response.data;
     ...
     */
    static async getCareTips(
        request: PlantCareRequest,
    ): Promise<PlantCareResponse> {
        try {
            const response = await api.post<PlantCareResponse>(
                "/analysis/care-tips",
                request,
            );
            return response.data;
    ...
    static async getAnalysisDetail(
        ...
        try {
            ...
            throw new Error(
                getErrorMessage(error, "Failed to fetch analysis detail"),
            );
        }
    }
    ...
    static async deleteAnalysis(analysisId: string): Promise<void> {
        try {
            ...
            throw new Error(
                getErrorMessage(error, "Failed to delete analysis"),
            );
        }
    }
}